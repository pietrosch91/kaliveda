...
Bool_t KVFAZIAReconDataAnalyser::CheckTaskVariables()
{
...
void KVFAZIAReconDataAnalyser::ChooseKVDataSelector()
{
...
void KVFAZIAReconDataAnalyser::WriteBatchEnvFile(const Char_t* jobname, Bool_t save)
{
...
Bool_t KVFAZIAReconDataAnalyser::ReadBatchEnvFile(const Char_t* filename)
{
...
void KVFAZIAReconDataAnalyser::SetKVDataSelector(const Char_t* kvs)
{
...
const Char_t* KVFAZIAReconDataAnalyser::ExpandAutoBatchName(const Char_t* format)
{
...
KVNumberList KVFAZIAReconDataAnalyser::PrintAvailableRuns(KVString& datatype)
{
...
TEnv* KVFAZIAReconDataAnalyser::GetReconDataTreeInfos() const
{
   return (TEnv*)theChain->GetTree()->GetUserInfo()->FindObject("TEnv");
}

void KVFAZIAReconDataAnalyser::PrintTreeInfos()
{
   // Print informations on currently analysed TTree
   TEnv* treeInfos = GetReconDataTreeInfos();
   if (!treeInfos) {
      Warning("PrintTreeInfos", "pas de tree info");
      return;
   }
   cout << endl << "----------------------------------------------------------------------------------------------------" << endl;
