...
public:
   ...
   void SetChannelWidth(double tau)
   {
      fChannelWidth = tau;
   }
   ...
   void SetSemiGaussParameter(Double_t sig)
   {
      fGaussSigma = sig;
   }
   ...
   Double_t GetBLLength()
   {
      return fLastBL - fFirstBL;
   }
   Double_t GetTrapRiseTime()
   {
      return fTrapRiseTime;
   }
   Double_t GetTrapFlatTop()
   {
      return fTrapFlatTop;
   }
