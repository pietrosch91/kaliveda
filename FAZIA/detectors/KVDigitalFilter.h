...
//    virtual void DrawStepResponse(Option_t* option=""); // DRAW signal
    ...
    static int Double2DSP(const double &val) {return (int)(val*32768*256+0.5);}
    static double DSP2Double(const int val) {return val/(32768.*256.);}
    ...
    inline double *GetXarray(){return a;}
    inline double *GetYarray(){return b;}
