...
void F77_FUNC(fitede,FITEDE)(const int *,const float *,const float *,
   const float *,const float *,const int *,const int*,
   const float *,const float *,const float *,float *,int *,int *) ;
double F77_FUNC(fede,FEDE)(float *Z,float *A,float *E) ;
 ...
 *            -3 -> addressing problem between Fortran and C
 */
int fitede_c(int npts,const float *zd,const float *ad,const float *xd,
             const float *yd,int ixt,int ih,const float *sc,const float *bl,
             const float *bu,float *par,int *istate)
{
  int lnpts, lixt, lih, irc ;
  ...
  lixt = ixt ;
  lih = ih ;
  F77_FUNC(fitede,FITEDE)(&lnpts,zd,ad,xd,yd,&lixt,&lih,sc,bl,bu,par,istate,&irc) ;
  return irc ;
}
 ...
 */
float fede_c(float Z,float A,float E)
{
  float lZ, lA,lE ;
  ...
  lA = A ;
  lE = E ;
  return ((float)F77_FUNC(fede,FEDE)(&lZ,&lA,&lE)) ;
}
