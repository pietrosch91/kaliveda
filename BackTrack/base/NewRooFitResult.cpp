...
NewRooFitResult::NewRooFitResult(const char* name, const char* title) : 
...
//_____________________________________________________________________________
NewRooFitResult::NewRooFitResult(const NewRooFitResult& other) : 
  TNamed(other),
  RooPrintable(other),
  RooDirItem(other),
...
//_____________________________________________________________________________
void NewRooFitResult::setConstParList(const RooArgList& list) 
{
...
//_____________________________________________________________________________
void NewRooFitResult::setInitParList(const RooArgList& list)
{
...
//_____________________________________________________________________________
void NewRooFitResult::setFinalParList(const RooArgList& list)
{
...
//_____________________________________________________________________________
Int_t NewRooFitResult::statusCodeHistory(UInt_t icycle) const
{ 
  if (icycle>=_statusHistory.size()) {
    coutE(InputArguments) << "NewRooFitResult::statusCodeHistory(" << GetName() 
...
//_____________________________________________________________________________
const char* NewRooFitResult::statusLabelHistory(UInt_t icycle) const 
{ 
  if (icycle>=_statusHistory.size()) {
    coutE(InputArguments) << "NewRooFitResult::statusLabelHistory(" << GetName() 
			  << " ERROR request for status history slot " 
			  << icycle << " exceeds history count of " << _statusHistory.size() << endl ;
  }
...
//_____________________________________________________________________________
RooPlot *NewRooFitResult::plotOn(RooPlot *frame, const char *parName1, const char *parName2,
			      const char *options) const 
{
  ...
  if(0 == par1) {
    coutE(InputArguments) << "NewRooFitResult::correlationPlot: parameter not floated in fit: " << parName1 << endl;
    return 0;
  }
  const RooRealVar *par2= dynamic_cast<const RooRealVar*>(floatParsFinal().find(parName2));
  if(0 == par2) {
    coutE(InputArguments) << "NewRooFitResult::correlationPlot: parameter not floated in fit: " << parName2 << endl;
    return 0;
  }
...
//_____________________________________________________________________________
const RooArgList& NewRooFitResult::randomizePars() const 
{
  ...
  // object is overwritten with each call and belongs to the NewRooFitResult. Uses
...
//_____________________________________________________________________________
Double_t NewRooFitResult::correlation(const char* parname1, const char* parname2) const 
{
  ...
  if (idx1<0) {
    coutE(InputArguments) << "NewRooFitResult::correlation(" << GetName() << ") parameter " << parname1 << " is not a floating fit parameter" << endl ;
    return 0 ;
  }
  if (idx2<0) {
    coutE(InputArguments) << "NewRooFitResult::correlation(" << GetName() << ") parameter " << parname2 << " is not a floating fit parameter" << endl ;
    return 0 ;
  }
...
//_____________________________________________________________________________
const RooArgList* NewRooFitResult::correlation(const char* parname) const 
{
  ...
  if (!arg) {
    coutE(InputArguments) << "NewRooFitResult::correlation: variable " << parname << " not a floating parameter in fit" << endl ;
    return 0 ;
  }    
...
//_____________________________________________________________________________
Double_t NewRooFitResult::globalCorr(const char* parname) 
{
  ...
  RooAbsArg* arg = _initPars->find(parname) ;
  if (!arg) {
    coutE(InputArguments) << "NewRooFitResult::globalCorr: variable " << parname << " not a floating parameter in fit" << endl ;
    return 0 ;
  }    
...
//_____________________________________________________________________________
const RooArgList* NewRooFitResult::globalCorr() 
{
...
//_____________________________________________________________________________
Double_t NewRooFitResult::correlation(Int_t row, Int_t col) const 
{
...
//_____________________________________________________________________________
Double_t NewRooFitResult::covariance(Int_t row, Int_t col) const 
{
...
//_____________________________________________________________________________
void NewRooFitResult::printMultiline(ostream& os, Int_t /*contents*/, Bool_t verbose, TString indent) const
{
  ...
  os << endl 
     << indent << "  NewRooFitResult: minimized FCN value: " << _minNLL << ", estimated distance to minimum: " << _edm << endl
...
//_____________________________________________________________________________
void NewRooFitResult::fillCorrMatrix(const std::vector<double>& globalCC, const TMatrixDSym& corrs, const TMatrixDSym& covs)
{
  // Function called by NewRooMinimizer

  // Sanity check
  if (globalCC.empty() || corrs.GetNoElements() < 1 || covs.GetNoElements() < 1) {
    coutI(Minimization) << "NewRooFitResult::fillCorrMatrix: number of floating parameters is zero, correlation matrix not filled" << endl ;
    return ;
  }

  if (!_initPars) {
    coutE(Minimization) << "NewRooFitResult::fillCorrMatrix: ERROR: list of initial parameters must be filled first" << endl ;
    return ;
  }
...
//_____________________________________________________________________________
void NewRooFitResult::fillLegacyCorrMatrix() const 
{
  // Sanity check
  if (!_CM) return ;
...
//_____________________________________________________________________________
void NewRooFitResult::fillCorrMatrix()
{
...
//_____________________________________________________________________________
void NewRooFitResult::setCovarianceMatrix(TMatrixDSym& V) 
{
  // Store externally provided correlation matrix in this NewRooFitResult ;
...
//_____________________________________________________________________________
TH2* NewRooFitResult::correlationHist(const char* name) const 
{
...
//_____________________________________________________________________________
const TMatrixDSym& NewRooFitResult::covarianceMatrix() const 
{
...
//_____________________________________________________________________________
TMatrixDSym NewRooFitResult::reducedCovarianceMatrix(const RooArgList& params) const 
{
  ...
  while((arg=(RooAbsArg*)iter->Next())) {
    if (_finalPars->find(arg->GetName())) {
      ...
      coutW(InputArguments) << "NewRooFitResult::reducedCovarianceMatrix(" << GetName() << ") WARNING input variable " 
...
//_____________________________________________________________________________
TMatrixDSym NewRooFitResult::conditionalCovarianceMatrix(const RooArgList& params) const 
{
  ...
  if (det<=0) {
    coutE(Eval) << "NewRooFitResult::conditionalCovarianceMatrix(" << GetName() << ") ERROR: covariance matrix is not positive definite (|V|=" 
		<< det << ") cannot reduce it" << endl ;
    throw string("NewRooFitResult::conditionalCovarianceMatrix() ERROR, input covariance matrix is not positive definite") ;
  }
  ...
  while((arg=(RooAbsArg*)iter->Next())) {
    if (_finalPars->find(arg->GetName())) {
      ...
      coutW(InputArguments) << "NewRooFitResult::conditionalCovarianceMatrix(" << GetName() << ") WARNING input variable " 
			    << arg->GetName() << " was not a floating parameters in fit result and is ignored" << endl ;
    }
  }
  delete iter ;
...
//_____________________________________________________________________________
const TMatrixDSym& NewRooFitResult::correlationMatrix() const 
{
...
//_____________________________________________________________________________
RooAbsPdf* NewRooFitResult::createHessePdf(const RooArgSet& params) const
{
  ...
  if (det<=0) {
    coutE(Eval) << "NewRooFitResult::createHessePdf(" << GetName() << ") ERROR: covariance matrix is not positive definite (|V|=" 
  ...
  while((arg=(RooAbsArg*)iter->Next())) {
    if (_finalPars->find(arg->GetName())) {
      ...
      coutW(InputArguments) << "NewRooFitResult::createHessePdf(" << GetName() << ") WARNING input variable " 
			    << arg->GetName() << " was not a floating parameters in fit result and is ignored" << endl ;
    }
  }
  delete iter ;
...
//_____________________________________________________________________________
void NewRooFitResult::SetName(const char *name) 
{
  // Change name of NewRooFitResult object
...
//_____________________________________________________________________________
void NewRooFitResult::SetNameTitle(const char *name, const char* title) 
{
  // Change name and title of NewRooFitResult object
...
//_____________________________________________________________________________
void NewRooFitResult::printName(ostream& os) const 
{
...
//_____________________________________________________________________________
void NewRooFitResult::printTitle(ostream& os) const 
{
...
//_____________________________________________________________________________
void NewRooFitResult::printClassName(ostream& os) const 
{
...
//_____________________________________________________________________________
void NewRooFitResult::printArgs(ostream& os) const 
{
...
//_____________________________________________________________________________
void NewRooFitResult::printValue(ostream& os) const 
{
...
//_____________________________________________________________________________
Int_t NewRooFitResult::defaultPrintContents(Option_t* /*opt*/) const 
{
...
//_____________________________________________________________________________
RooPrintable::StyleOption NewRooFitResult::defaultPrintStyle(Option_t* opt) const 
{
...
void NewRooFitResult::Streamer(TBuffer &R__b)
{
   // Stream an object of class NewRooFitResult.
    
  if (R__b.IsReading()) {
    UInt_t R__s, R__c;
    Version_t R__v = R__b.ReadVersion(&R__s, &R__c);     
    if (R__v>3) {    
      R__b.ReadClassBuffer(NewRooFitResult::Class(),this,R__v,R__s,R__c);    
    } else {
      ...
      R__b.CheckByteCount(R__s, R__c, NewRooFitResult::IsA());
	...
	delete cIter ;
      ...
      R__b.WriteClassBuffer(NewRooFitResult::Class(),this);
   }
}
