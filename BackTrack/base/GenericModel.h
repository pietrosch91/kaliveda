...
namespace BackTrack {
   ...
   public:
      ...
      Int_t GetNumberOfParameters() const
      {
      ...
      Int_t GetNumberOfObservables() const
      {
         return fParameters.getSize();
      }
      const RooArgList& GetObservables() const
      {
         return fObservables;
      }
      const RooArgList& GetParameters() const
      {
         return fParameters;
      }
      RooRealVar& GetParameter(const char* name)
      {
         return *((RooRealVar*)GetParameters().find(name));
      }
      RooRealVar& GetObservable(const char* name)
      {
         return *((RooRealVar*)GetObservables().find(name));
      }
      ...
      Int_t GetNumberOfDataSets() const
      {
         return fNDataSets;
      }
      const TObjArray* GetDataSetParametersList() const
      {
         return &fDataSetParams;
      }
      ...
      const RooAddPdf* GetPseudoPDF() const
      {
