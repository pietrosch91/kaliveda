...
/* -->
<h2>NewRooAbsData</h2>
<h4>Derived class of NewRooAbsData modified to include NewRooAbsOptTestStatistic as a friend class</h4>
<!-- */
// --> END_HTML
////////////////////////////////////////////////////////////////////////////////
...
ClassImp(NewRooAbsData)


static std::map<NewRooAbsData*,int> _dcc ;

NewRooAbsData::StorageType NewRooAbsData::defaultStorageType=NewRooAbsData::Vector ;


//_____________________________________________________________________________
void NewRooAbsData::setDefaultStorageType(NewRooAbsData::StorageType s) 
{
...
//_____________________________________________________________________________
NewRooAbsData::StorageType NewRooAbsData::getDefaultStorageType( ) 
{
...
//_____________________________________________________________________________
void NewRooAbsData::claimVars(NewRooAbsData* data) 
{
  _dcc[data]++ ;
  //cout << "NewRooAbsData(" << data << ") claim incremented to " << _dcc[data] << endl ;
}


//_____________________________________________________________________________
Bool_t NewRooAbsData::releaseVars(NewRooAbsData* data) 
{
  ...
  //cout << "NewRooAbsData(" << data << ") claim decremented to " << _dcc[data] << endl ;
  return (_dcc[data]==0) ;
}


//_____________________________________________________________________________
NewRooAbsData::NewRooAbsData() 
{
  // Default constructor
  claimVars(this) ;
  _dstore = 0 ;
...
//_____________________________________________________________________________
NewRooAbsData::NewRooAbsData(const char *name, const char *title, const RooArgSet& vars, RooAbsDataStore* dstore) :
...
//_____________________________________________________________________________
NewRooAbsData::NewRooAbsData(const NewRooAbsData& other, const char* newname) : 
  ...
  _cachedVars("Cached Variables")
{
  ...
  if (other._ownedComponents.size()>0) {
    ...
    for (std::map<std::string,NewRooAbsData*>::const_iterator itero =other._ownedComponents.begin() ; itero!=other._ownedComponents.end() ; ++itero ) {
      NewRooAbsData* dclone = (NewRooAbsData*) itero->second->Clone() ;
...
NewRooAbsData::~NewRooAbsData() 
{
  ...
  for(map<std::string,NewRooAbsData*>::iterator iter = _ownedComponents.begin() ; iter!= _ownedComponents.end() ; ++iter) {
    delete iter->second ;
  }
...
//_____________________________________________________________________________
void NewRooAbsData::convertToVectorStore() 
{
...
//_____________________________________________________________________________
Bool_t NewRooAbsData::changeObservableName(const char* from, const char* to)
{
...
//_____________________________________________________________________________
Int_t NewRooAbsData::numEntries() const
{
...
//_____________________________________________________________________________
const RooArgSet* NewRooAbsData::get(Int_t index) const 
{
  checkInit() ;
...
//_____________________________________________________________________________
void NewRooAbsData::cacheArgs(const RooAbsArg* cacheOwner, RooArgSet& varSet, const RooArgSet* nset, Bool_t skipZeroWeights) 
{
...
//_____________________________________________________________________________
void NewRooAbsData::attachCache(const RooAbsArg* newOwner, const RooArgSet& cachedVars) 
{
...
//_____________________________________________________________________________
void NewRooAbsData::setArgStatus(const RooArgSet& set, Bool_t active) 
{
...
//_____________________________________________________________________________
void NewRooAbsData::setDirtyProp(Bool_t flag) 
{ 
...
//_____________________________________________________________________________
NewRooAbsData* NewRooAbsData::reduce(const RooCmdArg& arg1,const RooCmdArg& arg2,const RooCmdArg& arg3,const RooCmdArg& arg4,
			       const RooCmdArg& arg5,const RooCmdArg& arg6,const RooCmdArg& arg7,const RooCmdArg& arg8) 
{
  ...
  RooCmdConfig pc(Form("NewRooAbsData::reduce(%s)",GetName())) ;
  ...
  if (varSet) {
	...
	coutW(InputArguments) << "NewRooAbsData::reduce(" << GetName() << ") WARNING: variable " 
...
//_____________________________________________________________________________
NewRooAbsData* NewRooAbsData::reduce(const char* cut) 
{ 
...
//_____________________________________________________________________________
NewRooAbsData* NewRooAbsData::reduce(const RooFormulaVar& cutVar) 
{
  // Create a subset of the data set by applying the given cut on the data points.
...
//_____________________________________________________________________________
NewRooAbsData* NewRooAbsData::reduce(const RooArgSet& varSubset, const char* cut) 
{
  // Create a subset of the data set by applying the given cut on the data points
...
//_____________________________________________________________________________
NewRooAbsData* NewRooAbsData::reduce(const RooArgSet& varSubset, const RooFormulaVar& cutVar) 
{
  // Create a subset of the data set by applying the given cut on the data points
  // and reducing the dimensions to the specified set.
  // 
...
//_____________________________________________________________________________
Double_t NewRooAbsData::weightError(ErrorType) const 
{ 
...
//_____________________________________________________________________________
void NewRooAbsData::weightError(Double_t& lo, Double_t& hi, ErrorType) const 
{ 
...
//_____________________________________________________________________________
RooPlot* NewRooAbsData::plotOn(RooPlot* frame, const RooCmdArg& arg1, const RooCmdArg& arg2,
			    ...
			    const RooCmdArg& arg6, const RooCmdArg& arg7, const RooCmdArg& arg8) const
{
  ...
  // DataError(NewRooAbsData::EType)    -- Select the type of error drawn: Poisson (default) draws asymmetric Poisson
...
//_____________________________________________________________________________
TH1 *NewRooAbsData::createHistogram(const char* varNameList, Int_t xbins, Int_t ybins, Int_t zbins) const
{
  ...
  if (!xvar) {
    coutE(InputArguments) << "NewRooAbsData::createHistogram(" << GetName() << ") ERROR: dataset does not contain an observable named " << varName << endl ;
    return 0 ;
  }
  varName = strtok(0,",") ; 
...
//_____________________________________________________________________________
TH1 *NewRooAbsData::createHistogram(const char *name, const RooAbsRealLValue& xvar,
...
//_____________________________________________________________________________
TH1 *NewRooAbsData::createHistogram(const char *name, const RooAbsRealLValue& xvar, const RooLinkedList& argListIn) const
{
  // Internal method that implements histogram filling
  RooLinkedList argList(argListIn) ;
  
  // Define configuration for this method
  RooCmdConfig pc(Form("NewRooAbsData::createHistogram(%s)",GetName())) ;
...
//_____________________________________________________________________________
Roo1DTable* NewRooAbsData::table(const RooArgSet& catSet, const char* cuts, const char* opts) const 
{
  ...
  while((arg=(RooAbsArg*)iter->Next())) {
	...
	prodName += " x " ;
      ...
      coutW(InputArguments) << "NewRooAbsData::table(" << GetName() << ") non-RooAbsCategory input argument " << arg->GetName() << " ignored" << endl ;
    }
  }
  prodName += ")" ;
  delete iter ;
...
//_____________________________________________________________________________
void NewRooAbsData::printName(ostream& os) const 
{
...
//_____________________________________________________________________________
void NewRooAbsData::printTitle(ostream& os) const 
{
...
//_____________________________________________________________________________
void NewRooAbsData::printClassName(ostream& os) const 
{
...
//_____________________________________________________________________________
void NewRooAbsData::printMultiline(ostream& os, Int_t contents, Bool_t verbose, TString indent) const
{
...
//_____________________________________________________________________________
Int_t NewRooAbsData::defaultPrintContents(Option_t* /*opt*/) const 
{
...
//_____________________________________________________________________________
Double_t NewRooAbsData::standMoment(RooRealVar &var, Double_t order, const char* cutSpec, const char* cutRange) const 
{
...
//_____________________________________________________________________________
Double_t NewRooAbsData::moment(RooRealVar &var, Double_t order, const char* cutSpec, const char* cutRange) const 
{
...
//_____________________________________________________________________________
Double_t NewRooAbsData::moment(RooRealVar &var, Double_t order, Double_t offset, const char* cutSpec, const char* cutRange) const
{
...
//_____________________________________________________________________________
RooRealVar* NewRooAbsData::dataRealVar(const char* methodname, RooRealVar& extVar) const 
{
...
//_____________________________________________________________________________
Double_t NewRooAbsData::corrcov(RooRealVar &x,RooRealVar &y, const char* cutSpec, const char* cutRange, Bool_t corr) const 
{
...
//_____________________________________________________________________________
TMatrixDSym* NewRooAbsData::corrcovMatrix(const RooArgList& vars, const char* cutSpec, const char* cutRange, Bool_t corr) const 
{
...
//_____________________________________________________________________________
RooRealVar* NewRooAbsData::meanVar(RooRealVar &var, const char* cutSpec, const char* cutRange) const
{
...
//_____________________________________________________________________________
RooRealVar* NewRooAbsData::rmsVar(RooRealVar &var, const char* cutSpec, const char* cutRange) const
{
...
//_____________________________________________________________________________
RooPlot* NewRooAbsData::statOn(RooPlot* frame, const RooCmdArg& arg1, const RooCmdArg& arg2, 
			    const RooCmdArg& arg3, const RooCmdArg& arg4, const RooCmdArg& arg5, 
...
//_____________________________________________________________________________
RooPlot* NewRooAbsData::statOn(RooPlot* frame, const char* what, const char *label, Int_t sigDigits,
...
//_____________________________________________________________________________
TH1 *NewRooAbsData::fillHistogram(TH1 *hist, const RooArgList &plotVars, const char *cuts, const char* cutRange) const
{
  ...
  for(Int_t i=0; i < nevent; ++i) {
    ...
    Double_t we = weightError(NewRooAbsData::SumW2) ;    
    if (we==0) we = weight() ;
...
//_____________________________________________________________________________
TList* NewRooAbsData::split(const RooAbsCategory& splitCat, Bool_t createEmptyDataSets) const
{
  ...
  if (createEmptyDataSets) {
    ...
    while ((state=(RooCatType*)stateIter->Next())) {
      NewRooAbsData* subset = emptyClone(state->GetName(),state->GetName(),&subsetVars,(addWV?"weight":0)) ;
  ...
  for (Int_t i = 0; i < numEntries(); ++i) {
    ...
    NewRooAbsData* subset = (NewRooAbsData*) dsetList->FindObject(cloneCat->getLabel());
    if (!subset) {
...
//_____________________________________________________________________________
RooPlot* NewRooAbsData::plotOn(RooPlot* frame, const RooLinkedList& argList) const
{
  // Plot dataset on specified frame. By default an unbinned dataset will use the default binning of
  // the target frame. A binned dataset will by default retain its intrinsic binning.
  //
  ...
  // DataError(NewRooAbsData::EType)    -- Select the type of error drawn: 
  ...
  pc.defineInt("errorType","DataError",0,(Int_t)NewRooAbsData::Auto) ;
  ...
  o.etype = (NewRooAbsData::ErrorType) pc.getInt("errorType") ;
  ...
  if (o.etype == Auto) {
    ...
    if (o.etype == SumW2) {
      coutI(InputArguments) << "NewRooAbsData::plotOn(" << GetName() 
  ...
  if (o.addToHistName && !frame->findObject(o.addToHistName,RooHist::Class())) {
    coutE(InputArguments) << "NewRooAbsData::plotOn(" << GetName() << ") cannot find existing histogram " << o.addToHistName 
...
//_____________________________________________________________________________
RooPlot *NewRooAbsData::plotOn(RooPlot *frame, PlotOpt o) const 
{
  ...
  if (dataVar->getMin()<var->getMin() || dataVar->getMax()>var->getMax()) {
    NewRooAbsData* tmp = ((NewRooAbsData*)this)->reduce(*var) ;
    nEnt = tmp->sumEntries() ;
    delete tmp ;
  }
...
//_____________________________________________________________________________
RooPlot* NewRooAbsData::plotAsymOn(RooPlot* frame, const RooAbsCategoryLValue& asymCat, PlotOpt o) const 
{
...
//_____________________________________________________________________________
RooPlot* NewRooAbsData::plotEffOn(RooPlot* frame, const RooAbsCategoryLValue& effCat, PlotOpt o) const 
{
...
//_____________________________________________________________________________
Roo1DTable* NewRooAbsData::table(const RooAbsCategory& cat, const char* cuts, const char* /*opts*/) const
{
...
//_____________________________________________________________________________
Bool_t NewRooAbsData::getRange(RooRealVar& var, Double_t& lowest, Double_t& highest, Double_t marginFrac, Bool_t symMode) const 
{
...
//_____________________________________________________________________________
void NewRooAbsData::optimizeReadingWithCaching(RooAbsArg& arg, const RooArgSet& cacheList, const RooArgSet& keepObsList)
{
...
//_____________________________________________________________________________
Bool_t NewRooAbsData::allClientsCached(RooAbsArg* var, const RooArgSet& cacheList)
{
...
//_____________________________________________________________________________
void NewRooAbsData::attachBuffers(const RooArgSet& extObs) 
{ 
...
//_____________________________________________________________________________
void NewRooAbsData::resetBuffers() 
{ 
...
//_____________________________________________________________________________
Bool_t NewRooAbsData::canSplitFast() const 
{
...
//_____________________________________________________________________________
NewRooAbsData* NewRooAbsData::getSimData(const char* name)
{
  map<string,NewRooAbsData*>::iterator i = _ownedComponents.find(name) ;
...
//_____________________________________________________________________________
void NewRooAbsData::addOwnedComponent(const char* idxlabel, NewRooAbsData& data) 
{ 
...
void NewRooAbsData::Streamer(TBuffer &R__b)
{
   // Stream an object of class NewRooAbsData.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(NewRooAbsData::Class(),this);

      // Convert on the fly to vector storage if that the current working default
      if (defaultStorageType==NewRooAbsData::Vector) {
	convertToVectorStore() ;
      }

   } else {
      R__b.WriteClassBuffer(NewRooAbsData::Class(),this);
   }
}
...
//_____________________________________________________________________________
void NewRooAbsData::checkInit() const
{ 
  _dstore->checkInit() ; 
}
...
//_____________________________________________________________________________
void NewRooAbsData::Draw(Option_t* option) 
{ 
...
//_____________________________________________________________________________
Bool_t NewRooAbsData::hasFilledCache() const 
{ 
...
//_____________________________________________________________________________
const TTree* NewRooAbsData::tree() const 
{ 
  return _dstore->tree() ; 
}
