...
public:
   ...
   void SetDeadGasThickness(Float_t x)
   {
      deadGas->SetThickness(x);
   };
   void SetDeadGasPressure(Float_t x)
   {
      deadGas->SetPressure(x);
   };

   void SetActiveGasThickness(Float_t x)
   {
      activeGas->SetThickness(x);
   };
   void SetActiveGasPressure(Float_t x)
   {
      activeGas->SetPressure(x);
   };
