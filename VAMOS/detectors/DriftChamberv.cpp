...
void DriftChamberv::Calibrate(void)
{
  ...
  for(i=0;i<2;i++)
    ...
    tRef[0] = 98.994;  // TOF Ca-20+ to DC using 8.22cm/ns
    tRef[1] = 109.5005;  

    tProperElastic[0] = 2039.35;
    tProperElastic[1] = 1933.49;
    //tProperElastic[0] = 2005.23;
    //tProperElastic[1] = 1925.36;
