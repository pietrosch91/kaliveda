...
void Parameters::Check(void)
{
  ...
  if(
    ...
    {fParameterType[fNumberofParameters-1] = 4;STRB = true;}
  else if(
	  strncmp(fParameterName[fNumberofParameters-1].Name, "STR_12",6) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 5;STRB = true;}
  else if(
	  strncmp(fParameterName[fNumberofParameters-1].Name, "STR_21",6) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 6;STRB = true;}
  else if(
	  strncmp(fParameterName[fNumberofParameters-1].Name, "STR_22",6) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 7;STRB = true;}
#endif
...
&&
    ...
    {fParameterType[fNumberofParameters-1] = 1;EchiB=true;}
  else if(
	  strncmp(fParameterName[fNumberofParameters-1].Name, "ECHI_B",6) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 2;EchiB=true;}
  else if(
	  strncmp(fParameterName[fNumberofParameters-1].Name, "ECHI_C",6) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 3;EchiB=true;}
#endif
    ...
    {fParameterType[fNumberofParameters-1] = 8; ECCEB=true; }
  else if(
	  strncmp(fParameterName[fNumberofParameters-1].Name, "ECC",3) == 0 &&
	  (
    ...
    {fParameterType[fNumberofParameters-1] = 9; ECCTB=true;}
#endif
#ifdef ECC20MEV
  else if(
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "ECC",3) == 0 &&
    ...
    {fParameterType[fNumberofParameters-1] = 23; ECC20EB=true; }
#endif
    ...
    {fParameterType[fNumberofParameters-1] = 21; GOCCEEB=true;}
  else if(
	  strncmp(fParameterName[fNumberofParameters-1].Name, "GOCCE",5) == 0 &&
	  (
    ...
    {fParameterType[fNumberofParameters-1] = 22; GOCCETB=true;}
#endif
#ifdef SI
  else if(
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "SIE",3) == 0 
	  )
    {fParameterType[fNumberofParameters-1] = 19; SIEB=true;}
#endif
    ...
    {fParameterType[fNumberofParameters-1] = 25; ICSILB=true;}
  else if(
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "CSI_",4) == 0 &&
	  strncmp((fParameterName[fNumberofParameters-1]).Name+8, "_R",2) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 26; ICSIRB=true;}
  else if(
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "CSI_",4) == 0 &&
	  strncmp((fParameterName[fNumberofParameters-1]).Name+8, "_T",2) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 27; ICSITB=true;}
  else if(
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "SI_",3) == 0 &&
	  strncmp((fParameterName[fNumberofParameters-1]).Name+7, "_PG",3) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 28; ISILB=true;}
  else if(
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "SI_",3) == 0 &&
	  strncmp((fParameterName[fNumberofParameters-1]).Name+7, "_GG",3) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 29; ISIHB=true;}
  else if(
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "SI_",3) == 0 &&
	  strncmp((fParameterName[fNumberofParameters-1]).Name+7, "_T",2) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 30; ISITB=true;}
  else if(
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "CI_",3) == 0 &&
	  strncmp((fParameterName[fNumberofParameters-1]).Name+7, "_PG",3) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 31; ICILB=true;}
  else if(
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "CI_",3) == 0 &&
	  strncmp((fParameterName[fNumberofParameters-1]).Name+7, "_GG",3) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 32; ICIHB=true;}
  else if(
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "CI_",3) == 0 &&
	  strncmp((fParameterName[fNumberofParameters-1]).Name+7, "_T",2) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 33; ICITB=true;}
#endif
    ...
    {fParameterType[fNumberofParameters-1] = 24; WCSIEB=true;}
  else if(
    ...
    {fParameterType[fNumberofParameters-1] = 34; WCSIEB=true;}
#endif
    ...
    {fParameterType[fNumberofParameters-1] = 10; ESSQB=true;}
  else if(
	  strncmp(fParameterName[fNumberofParameters-1].Name, "ESS",3) == 0 &&
	  (
	   strncmp(fParameterName[fNumberofParameters-1].Name+5, "TDC",3) == 0 ||
    ...
    {fParameterType[fNumberofParameters-1] = 11; ESSTB=true;}
  else if(
	  strncmp(fParameterName[fNumberofParameters-1].Name, "ESS",3) == 0 &&
	  (
    ...
    {fParameterType[fNumberofParameters-1] = 12;SEDB = true;}
  else if(
	  strncmp(fParameterName[fNumberofParameters-1].Name, "SED1_Y_",7) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 13;SEDB = true;}
  else if(
	  strncmp(fParameterName[fNumberofParameters-1].Name, "SED2_X_",7) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 14;SEDB = true;}
  else if(
	  strncmp(fParameterName[fNumberofParameters-1].Name, "SED2_Y_",7) == 0
	  )
    {fParameterType[fNumberofParameters-1] = 15;SEDB = true;}
#endif
#ifdef CSI
  else if((
	   strncmp((fParameterName[fNumberofParameters-1]).Name, "CsI",3) == 0 
    ...
    {fParameterType[fNumberofParameters-1] = 16; CSIEB=true;}
  else if((
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "CsI",3) == 0 
	  ||
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "CSI",3) == 0 
    ...
    {fParameterType[fNumberofParameters-1] = 17; CSITB=true;}
  else if((
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "CsI",3) == 0
	  ||
	  strncmp((fParameterName[fNumberofParameters-1]).Name, "CSI",3) == 0
    ...
    {fParameterType[fNumberofParameters-1] = 18; CSIPB=true;}
#endif
  else 
    {
...
void Parameters::Set(TTree * theTree)
{
  ...
  for(UShort_t i=0;i<fMaxParameterNumber;i++)
    {fParameterMap[i] = 0; fParameterMapT[i] = 0;}

  for(UShort_t i=0;i<fNumberofParametersFree;i++)
    {fParameterData[i] = 0; fParametersTouched[i] = 0;}
	...
	case 8: 
	      if(strncmp((fParameterName[i]).Name+6, "_",1) == 0)
		{
		  ...
		  if(strncmp((fParameterName[i]).Name+5, "A",1) == 0)
		    ...
		    Index=3;
		  else {cout << "Unknown Index " << Index << endl; exit(EXIT_FAILURE);}
		}
	      else
		{
	...
	case 9: 
	      if(strncmp(fParameterName[i].Name+6, "_",1) == 0)
		{
		  ...
		  if(strncmp(fParameterName[i].Name+5, "A",1) == 0)
		    ...
		    Index=3;
		  else {cout << "Unknown Index " << fParameterName[i].Name<< Index << endl; exit(EXIT_FAILURE);}
		}
	      else
		{
		  sscanf(fParameterName[i].Name+3,"%2d",&tmp);
