...
//    KVGraph(const char* filename, const char* format = "%lg %lg", Option_t* option = "");
    ...
    void SetDisplayDivX(Int_t ndiv, Double_t* div=0){fNDivX=ndiv; fDisplayDivX=div;}
    void SetDisplayDivY(Int_t ndiv, Double_t* div=0){fNDivY=ndiv; fDisplayDivY=div;}

    void SetCropMode(Int_t crop=kCropOnGraph){fCropMode=crop;}
    void SetUseX(Bool_t usex = kTRUE){fUseX=usex;}
    void SetUseY(Bool_t usey = kTRUE){fUseY=usey;}
