...
class KVWilckeReactionParameters
{
   ...
   TF1* GetBSSCoulombPotential() const { return fBSS; }
   TF1* GetNuclearProximityPotential() const { return fProx; }
   TF1* GetTotalPotential() const { return fPotential; }
   ...
   TF1* GetCMQuarterPointAngle() const { return fCMThetaQuart; }
   TF1* GetLmax() const { return fLmax; }
   ...
   TF1* GetReactionCrossSection() const { return fSigmaR; }
   ...
   TF1* GetFusionCrossSection() const { return fSigmaFus; }
