...
void KVWilckeReactionParameters::init()
{
    ...
    fCentPot = new TF1("CENTPOT", this, &KVWilckeReactionParameters::CentrifugalPotential, 0, 25, 2, "KVWilckeReactionParameters", "CentrifugalPotential");
    fCentPot->SetNpx(1000);
    fCentPot->SetParNames("E/A [MeV]", "b [fm]");
