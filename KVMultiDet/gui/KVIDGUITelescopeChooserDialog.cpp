...
<img alt="" src="images/IDTelescopeChooser.png"><br>
                             ...
                             UInt_t w, UInt_t h)
{
   ...
   fComboBox994 = new TGComboBox(fMainFrame979,-1,kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);
	...
	TIter next_type(id_types); TObjString * type_string; int entry_id = 0;
...
void KVIDGUITelescopeChooserDialog::FillTelescopeListWithType(const char* type)
{
	...
	fListBox980->Layout();
	KVCollection *telescopes = fMultiDet->GetIDTelescopesWithType(type);
