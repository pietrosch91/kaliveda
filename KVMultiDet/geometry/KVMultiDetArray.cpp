...
void KVMultiDetArray::CalculateGroupsFromGeometry()
{
    // Use a Monte-Carlo approach to analyse the array geometry previously set
    // by a call to SetGeometry and associate detectors into geometrical groups
}
