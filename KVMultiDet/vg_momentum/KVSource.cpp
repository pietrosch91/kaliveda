...
//
 ...
 switch (i)
  {
  case 0: rval=fSource.GetExcitEnergy();
  	  break;

  case 1: rval=fSource.GetZ();
  	  break;

  case 2: rval=fSource.GetA();
  	  break;

  case 3: rval=fSource.GetV().Z();
  	  break;

  case 4: rval=fSource.GetV().X();
  	  break;

  case 5: rval=fSource.GetV().Y();
  	  break;
...
//_________________________________________________________________
TObject *KVSource::GetObject(void)    
 {
//
