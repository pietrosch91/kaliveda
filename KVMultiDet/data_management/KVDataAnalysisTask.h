...
class KVDataAnalysisTask:public KVBase {
 ...
 public:
...
#endif
   virtual void SetPrereq(const Char_t *p) { fPrereq = p; };
   ...
   virtual void SetDataAnalyser(const Char_t* d) { fAnalyser = d; };
   virtual const Char_t* GetDataAnalyser() const { return fAnalyser; };
