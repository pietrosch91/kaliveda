...
public:
   ...
   Long_t GetLines() const
   {
      return fLignes;
   };
   Long_t GetColumns() const
   {
      return fCols;
   };
   Char_t GetOrientation() const
   {
      return fOrient;
   };
   Long_t GetStep() const
   {
      return fStep;
   };
   ...
   void SetLines(Long_t l)
   {
      fLignes = l;
   };
   void SetColumns(Long_t c)
   {
      fCols = c;
   };
   void SetOrientation(Char_t o)
   {
      fOrient = o;
   };
   void SetStep(Long_t s)
   {
      fStep = s;
   };
