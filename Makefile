...
ifeq ($(SITE),CCIN2P3)
	...
	-ln -s $(THRONG_DIR)/KaliVeda/KVFiles/INDRA_e494s/ccali.available_runs.e503.recon3 $(KVINSTALLDIR)/KVFiles/INDRA_e494s/ccali.available_runs.e503.recon3
	-ln -s $(THRONG_DIR)/KaliVeda/KVFiles/INDRA_e494s/ccali.available_runs.e503.ident3 $(KVINSTALLDIR)/KVFiles/INDRA_e494s/ccali.available_runs.e503.ident3
	...
	-ln -s $(THRONG_DIR)/KaliVeda/KVFiles/INDRA_e494s/ccali.available_runs.e494s.recon3 $(KVINSTALLDIR)/KVFiles/INDRA_e494s/ccali.available_runs.e494s.recon3
	-ln -s $(THRONG_DIR)/KaliVeda/KVFiles/INDRA_e494s/ccali.available_runs.e494s.ident3 $(KVINSTALLDIR)/KVFiles/INDRA_e494s/ccali.available_runs.e494s.ident3
